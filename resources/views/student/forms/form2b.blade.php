                ...
                <div
                    ...
                    <div class="flex flex-col md:basis-1/2 w-full">
                        ...
                        <input type="text" name="protocol_title"
                            class="block rounded border border-darkgray mt-1 w-full text-sm max-sm:text-[13px] h-[35px] max-lg:h-[30px]" required>
                    </div>
                    <div class="flex flex-col md:basis-1/2 w-full">
                        ...
                        <input type="text" name="pi_name"
                            class="mt-1 rounded border border-darkgray w-full text-sm max-sm:text-[13px] h-[35px] max-lg:h-[30px]" required>
                    </div>
                </div>
                <div
                    class="px-3 py-2 flex flex-col md:flex-row justify-between items-start md:space-x-5 space-y-5 md:space-y-0">
            ...
            <div class="mt-3 p-1 max-w-7xl w-full bg-lightgray rounded mx-auto shadow-md">
                ...
                <div class="p-3 space-y-2 text-base">
                    <div
                        ...
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="study_type"
                                value="Academic Requirement" data-group="2">
                            <span>Academic Requirement (Thesis, Dissertation, Training Requirement)</span>
                        </label>
                        <!-- INDEPENDENT RESEARCH WORK / RESEARCH INITIATED -->
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="study_type"
                                value="Independent Research Work/Researcher Initiated" data-group="2">
                        ...
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="study_type"
                                value="Multi-Disciplinary, Multi-Institutional or Multi-Country Collaboration"
                                data-group="2">
                        ...
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" id="toggleCheckBox"
                                class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="study_type" data-group="2">
                            <span>Others:</span>
                            <input type="text" id="textBox" class="text-sm h-[28px] rounded border border-darkgray"
                                placeholder="Others (specify)" name="study_type" disabled>
                        </label>
                    </div>
                </div>
                <div
                ...
                <div class="p-3 space-y-2 text-base">
                    ...
                    <div
                        ...
                        <!-- SELF-FUNDED -->
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="funds"
                                value="Self-Funded" data-group="3">
                            <span>Self-Funded</span>
                        </label>
                        <!-- GOVERNMENT-FUNDED -->
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="funds"
                                value="Government-Funded" data-group="3">
                            <span>Government-Funded</span>
                        </label>
                        <!-- RESEARCH GRANT -->
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="funds"
                                value="Research Grant/Scholarship" data-group="3">
                            <span>Research Grant/Scholarship</span>
                        </label>
                        <!-- INSTITUTION-FUNDED -->
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="funds"
                                value="Institution-Funded" data-group="3">
                        ...
                        <label class="flex max-sm:block max-sm:space-x-1 items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" id="toggleCheckBox"
                                class="check mt-1 max-sm:mt-0 max-sm:w-[14px] max-sm:h-[14px]" name="funds"
                                value="Sponsored by Pharmaceutical Company " data-group="3">
                            <span>Sponsored by Pharmaceutical Company</span>
                            <input type="text" id="textBox" class="text-sm h-[28px] rounded border border-darkgray"
                                placeholder="Specify" name="funds" disabled>
                        </label>
                        <!-- OTHERS -->
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" id="toggleCheckBox"
                                class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="funds" value="Others"
                                data-group="3">
                            <span>Others</span>
                            <input type="text" id="textBox" class="text-sm h-[28px] rounded border border-darkgray"
                                placeholder="Specify" name="funds" disabled>
                ...
                <div class="p-3 space-y-2 text-base">
                    ...
                    <div class="grid grid-cols-1 gap-x-5 gap-y-3 max-sm:gap-y-1">
                        <label class="max-sm:py-1 flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="tech_review"
                                data-group="4">
                ...
                <div class="p-3 space-y-2 text-base">
                    ...
                    <div class="grid grid-cols 1 gap-x-5">
                        <label class="max-sm:py-1 flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="erb_submit"
                                data-group="4">
                            <span>Yes</span>
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="erb_submit"
                                data-group="4">
            ...
            <div class="mt-3 p-1 max-w-7xl w-full bg-lightgray rounded mx-auto shadow-md">
                ...
                <div class="p-3 space-y-2 text-base">
                    ...
                    <div class="grid 2xl:grid-cols-3 max-md:grid-cols-1 md:grid-cols-2 max-lg:grid-cols-2 gap-y-3">
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Children" data-group="5">
                            <span>11.1. Children (under 18)</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Indigenous people" data-group="5">
                            <span>11.2. Indigenous people</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Elderly" data-group="5">
                            <span>11.3. Elderly</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="People on welfare/social assistance" data-group="5">
                            <span>11.4. People on welfare/social assistance</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Poor and unemployed" data-group="5">
                            <span>11.5. Poor and unemployed</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Patients in emergency care" data-group="5">
                            <span>11.6. Patients in emergency care</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Homeless persons" data-group="5">
                            <span>11.7. Homeless persons</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Refugees or displaced persons" data-group="5">
                            <span>11.8. Refugees or displaced persons</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
                                name="special_population" value="Patients with incurable diseases" data-group="5">
                            <span>11.9. Patients with incurable diseases</span>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" id="toggleCheckBox"
                                class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]" name="special_population"
                                value="Others" data-group="5">
                            <span>11.10. Others</span>
                            <input type="text" id="textBox" class="text-sm h-[28px] rounded border border-darkgray"
                                placeholder="Indicate" name="special_population" disabled>
                        </label>
                        <label class="flex items-start space-x-2 max-sm:text-sm/6">
                            <input type="checkbox" class="check mt-1 max-sm:w-[14px] max-sm:h-[14px]"
