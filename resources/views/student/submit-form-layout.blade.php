    ...
    <main class="ml-[335px] max-2xl:ml-auto p-4">
        ...
        <div class="p-6 max-md:p-0 space-y-10">
            <div class="duration-200 my-4 p-4 max-sm:p-0">
                ...
                <div class="">
                    <x-primary-button class="mt-4 border-2 border-primary hover:border-secondary">
                        SUBMIT
                    </x-primary-button>
                </div>
            </div>
...
<script>
    ...
    window.addEventListener("load", () => {
        ...
        const fileshow = (filename, filetype) => {
            ...
            showfileboxElem.classList.add("flex", "justify-between", "items-center", "my-[10px]", "px-3", "py-1", "shadow-md", "bg-lightgray", "border", "border-darkgray");
